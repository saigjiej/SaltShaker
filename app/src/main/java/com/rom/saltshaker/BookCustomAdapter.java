...
public class BookCustomAdapter extends RecyclerView.Adapter<BookCustomAdapter.CustomViewHolder> {
    private ArrayList<Book> arrayList;
    private Context context;

    public BookCustomAdapter(ArrayList<Book> arrayList, Context context) {
