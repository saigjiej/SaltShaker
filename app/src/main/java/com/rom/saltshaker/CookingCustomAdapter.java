...
public class CookingCustomAdapter extends RecyclerView.Adapter<CookingCustomAdapter.CustomViewHolder> {
    private ArrayList<Cooking> arrayList;
    private Context context;

    public CookingCustomAdapter(ArrayList<Cooking> arrayList, Context context) {
    ...
    public CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cooking_list_item, parent, false);
