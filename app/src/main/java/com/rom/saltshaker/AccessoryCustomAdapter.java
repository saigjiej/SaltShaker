...
public class AccessoryCustomAdapter extends RecyclerView.Adapter<AccessoryCustomAdapter.CustomViewHolder> {
    private ArrayList<Accessory> arrayList;
    private Context context;

    public AccessoryCustomAdapter(ArrayList<Accessory> arrayList, Context context) {
